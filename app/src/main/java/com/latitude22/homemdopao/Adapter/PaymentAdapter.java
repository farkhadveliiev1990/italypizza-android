...
public class PaymentAdapter extends BaseAdapter {
    ...
    public PaymentAdapter(ArrayList<AddCart> addCarts,Context Mcontext)
    {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        convertView = layoutInflater.inflate(R.layout.payment_item_list, null);
     ...
     //   EditText et_payment_qty = (EditText) convertView.findViewById(R.id.et_payment_qty);
       ...
       // unit_price.setText(""+addCarts.get(position).getUnitprice());
        ...
        double dd= (double) (addCarts.get(position).getProductprice()*addCarts.get(position).getProductquantity());
        payment_net_amount.setText(""+new DecimalFormat("##.##").format(dd).toString().replace(",","."));
    ...
    public double PriceTotal(ArrayList<AddCart> Cartlist){
        ...
        MyCart.cart_total_amount.setText(""+new DecimalFormat("##.##").format(total).toString().replace(",","."));
        return  total;
    }
}
